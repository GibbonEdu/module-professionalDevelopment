...
$URL = Url::fromModuleRoute('Professional Development', 'pd_portfolio_manage.php');
...
if (isActionAccessible($guid, $connection2, '/modules/Professional Development/pd_portfolio_manage.php') == false) {
    ...
    // Proceed!
    // Check if professionalDevelopmentPortfolioID specified
    ...
    if ($portfolioGateway->exists($professionalDevelopmentPortfolioID)) {
        $form = DeleteForm::createForm($session->get('absoluteURL').'/modules/Professional Development/pd_portfolio_deleteRecordProcess.php', true, false);
