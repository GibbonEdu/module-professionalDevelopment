...
$URL = $session->get('absoluteURL').'/index.php?q=/modules/'.$session->get('module').'/pd_resources_add.php';
...
if (!isActionAccessible($guid, $connection2, '/modules/Professional Development/pd_resources_add.php')) {
    ...
    $professionalDevelopmentResourceID = $staffResourceGateway->insert($resourceData);
    ...
    $URL .= "&return=success0&editID=$professionalDevelopmentResourceID";
    header("Location: {$URL}");
}