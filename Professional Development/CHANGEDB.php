...
$sql[$count][0] = "0.1.07";
$sql[$count][1] = "
INSERT INTO `gibbonSetting` (`gibbonSettingID`, `scope`, `name`, `nameDisplay`, `description`, `value`) VALUES (NULL, 'Professional Development', 'resourceCategories', 'Resource Categories', 'Allowable choices for category when creating a resource.', 'Article,Book,Document,Website');end
INSERT INTO `gibbonSetting` (`gibbonSettingID`, `scope`, `name`, `nameDisplay`, `description`, `value`) VALUES (NULL, 'Professional Development', 'resourcePurposes', 'Resource Purposes', 'Allowable choices for purpose when creating a resource.', 'Skill,Teaching and Learning,Assessment Aid,Strategy');end
CREATE TABLE `professionalDevelopmentResource` (`professionalDevelopmentResourceID` int(10) unsigned zerofill NOT NULL AUTO_INCREMENT, `name` varchar(255) NOT NULL, `description` text NOT NULL, `category` varchar(255) NOT NULL, `purpose` varchar(255) NOT NULL, `tags` text NOT NULL, `content` text NOT NULL, `gibbonPersonIDCreated` int(10) unsigned zerofill NOT NULL, `gibbonPersonIDModified` int(10) unsigned zerofill NOT NULL, `timestampCreated` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `timestampModified` timestamp NULL DEFAULT NULL, PRIMARY KEY (`professionalDevelopmentResourceID`)) ENGINE = InnoDB CHARSET=utf8;end
CREATE TABLE `professionalDevelopmentResourceTag` (`professionalDevelopmentResourceTagID` int(10) unsigned zerofill NOT NULL AUTO_INCREMENT, `tag` varchar(100) NOT NULL, PRIMARY KEY (`professionalDevelopmentResourceTagID`), UNIQUE KEY `tag` (`tag`)) ENGINE=InnoDB CHARSET=utf8;end
INSERT INTO `gibbonAction` (`gibbonModuleID`, `name`, `precedence`, `category`, `description`, `helpURL`, `URLList`, `entryURL`, `entrySidebar`, `menuShow`, `defaultPermissionAdmin`, `defaultPermissionTeacher`, `defaultPermissionStudent`, `defaultPermissionParent`, `defaultPermissionSupport`, `categoryPermissionStaff`, `categoryPermissionStudent`, `categoryPermissionParent`, `categoryPermissionOther`) VALUES ((SELECT gibbonModuleID FROM gibbonModule WHERE name='Professional Development'), 'Manage Resources_all', '1', 'Resources', 'Manage, create and edit all resources.', '', 'pd_resources_manage.php, pd_resources_add.php, pd_resources_edit.php, pd_resources_delete.php', 'pd_resources_manage.php', 'Y', 'Y', 'Y', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N');end
INSERT INTO `gibbonAction` (`gibbonModuleID`, `name`, `precedence`, `category`, `description`, `helpURL`, `URLList`, `entryURL`, `entrySidebar`, `menuShow`, `defaultPermissionAdmin`, `defaultPermissionTeacher`, `defaultPermissionStudent`, `defaultPermissionParent`, `defaultPermissionSupport`, `categoryPermissionStaff`, `categoryPermissionStudent`, `categoryPermissionParent`, `categoryPermissionOther`) VALUES((SELECT gibbonModuleID FROM gibbonModule WHERE name='Professional Development'), 'Manage Resources_my', 0, 'Resources', 'Allows users to create ands edit their own resources.', '', 'pd_resources_manage.php, pd_resources_add.php, pd_resources_edit.php, pd_resources_delete.php', 'pd_resources_manage.php', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'Y', 'Y', 'N', 'N', 'N');end
INSERT INTO `gibbonAction` (`gibbonModuleID`, `name`, `precedence`, `category`, `description`, `helpURL`, `URLList`, `entryURL`, `entrySidebar`, `menuShow`, `defaultPermissionAdmin`, `defaultPermissionTeacher`, `defaultPermissionStudent`, `defaultPermissionParent`, `defaultPermissionSupport`, `categoryPermissionStaff`, `categoryPermissionStudent`, `categoryPermissionParent`, `categoryPermissionOther`) VALUES ((SELECT gibbonModuleID FROM gibbonModule WHERE name='Professional Development'), 'View Resources', '0', 'Resources', 'View and filter all staff resources.', '', 'pd_resources_view.php', 'pd_resources_view.php', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'Y', 'Y', 'N', 'N', 'N');end
INSERT INTO `gibbonPermission` (`gibbonRoleID` ,`gibbonActionID`) VALUES (001, (SELECT gibbonActionID FROM gibbonAction JOIN gibbonModule ON (gibbonAction.gibbonModuleID=gibbonModule.gibbonModuleID) WHERE gibbonModule.name='Professional Development' AND gibbonAction.name='View Resources'));end
INSERT INTO `gibbonPermission` (`gibbonRoleID` ,`gibbonActionID`) VALUES (002, (SELECT gibbonActionID FROM gibbonAction JOIN gibbonModule ON (gibbonAction.gibbonModuleID=gibbonModule.gibbonModuleID) WHERE gibbonModule.name='Professional Development' AND gibbonAction.name='View Resources'));end
INSERT INTO `gibbonPermission` (`gibbonRoleID` ,`gibbonActionID`) VALUES (001, (SELECT gibbonActionID FROM gibbonAction JOIN gibbonModule ON (gibbonAction.gibbonModuleID=gibbonModule.gibbonModuleID) WHERE gibbonModule.name='Professional Development' AND gibbonAction.name='Manage Resources_all'));end
INSERT INTO `gibbonPermission` (`gibbonRoleID` ,`gibbonActionID`) VALUES (001, (SELECT gibbonActionID FROM gibbonAction JOIN gibbonModule ON (gibbonAction.gibbonModuleID=gibbonModule.gibbonModuleID) WHERE gibbonModule.name='Professional Development' AND gibbonAction.name='Manage Resources_my'));end
INSERT INTO `gibbonPermission` (`gibbonRoleID` ,`gibbonActionID`) VALUES (002, (SELECT gibbonActionID FROM gibbonAction JOIN gibbonModule ON (gibbonAction.gibbonModuleID=gibbonModule.gibbonModuleID) WHERE gibbonModule.name='Professional Development' AND gibbonAction.name='Manage Resources_my'));end
";