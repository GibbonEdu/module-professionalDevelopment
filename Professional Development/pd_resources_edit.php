...
if (!isActionAccessible($guid, $connection2, '/modules/Professional Development/pd_resources_edit.php')) {
    ...
    $form = Form::create('resourceForm', $session->get('absoluteURL').'/modules/Professional Development/pd_resources_editProcess.php');
    $form->setFactory(DatabaseFormFactory::create($pdo));
    $form->addHiddenValue('address', $session->get('address'));
    $form->addHiddenValue('professionalDevelopmentResourceID', $professionalDevelopmentResourceID);
